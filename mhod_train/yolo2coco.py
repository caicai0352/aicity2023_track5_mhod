...
parser.add_argument('--root_dir', default='../data/crop_yolo_data/train/',type=str, help="root path of images and labels, include ./images and ./labels and classes.txt")
parser.add_argument('--save_path', type=str,default='../data/aicity5/', help="if not split the dataset, give a path to a json file")
parser.add_argument('--save_name', type=str,default='train.json', help="if not split the dataset, give a path to a json file")
...
def yolo2coco(arg):
    ...
    with open('./DETA/classes_7.txt') as f:
