...
from engine import evaluate, train_one_epoch, submit
...
def get_args_parser():
    ...
    parser.add_argument('--coco_path', default='/mnt/home/datasets/panda/crop/ignore/', type=str)
    parser.add_argument('--coco_panoptic_path', type=str)
    parser.add_argument('--remove_difficult', action='store_true')
    parser.add_argument('--bigger', action='store_true')

    parser.add_argument('--output_dir', default='/mnt/home/aicity5/DETA/exps/submit_1lr_alldata/',
...
def main(args):
    ...
    if args.submit:
        test_stats, coco_evaluator = submit(model, criterion, postprocessors,
