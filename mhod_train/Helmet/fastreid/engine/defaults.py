...
def default_argument_parser():
    ...
    parser.add_argument("--config-file", default="./configs/cocobaidu.yml", metavar="FILE", help="path to config file")
    parser.add_argument(
        "--resume",
        action="store_true",
    ...
    port = 2 ** 15 + 2 ** 14 + hash(os.getuid() if sys.platform != "win32" else 1) % 2 ** 14+3
