...
class AttrTrainer(DefaultTrainer):
    ...
    def build_train_loader(cls, cfg):
        ...
        train_set = AttrDataset(cfg,train_items, train_transforms, attr_dict)
    ...
    def build_test_loader(cls, cfg, dataset_name):
        ...
        test_set = AttrDataset(cfg,test_items, test_transforms, attr_dict)
...
def main(args):
    ...
    if args.eval_only:
        ...
        cfg.MODEL.WEIGHTS = '/mnt/home/person_att/fast-reid-master/projects/DrvPassger/logs/data_0307/strong_baseline/model_best.pth'
        # cfg.MODEL.WEIGHTS = '/mnt/home/person_att/model_best.pth'
